...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    userLastName: Attribute.String & Attribute.Required;
    userAddress: Attribute.Text;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::users-permissions.user',
...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    categoryUrl: Attribute.UID<'api::category.category', 'categoryName'> &
      Attribute.Required;
    categoryDescription: Attribute.RichText & Attribute.Required;
    sub_categories_id: Attribute.Relation<
...
export interface ApiOrderDetailOrderDetail extends Schema.CollectionType {
  ...
  attributes: {
    orderDetailId: Attribute.String;
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    postUrl: Attribute.UID<'api::post.post', 'title'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    productUrl: Attribute.UID<'api::product.product', 'productName'>;
    stock: Attribute.Integer;
    sub_category_id: Attribute.Relation<
      'api::product.product',
      'oneToOne',
      'api::sub-category.sub-category'
    >;
    brand: Attribute.String;
    productSize: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'XS, S, M, L ,XS'>;
...
export interface ApiSubCategorySubCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category_id: Attribute.Relation<
      ...
      'api::category.category'
    >;
    subCategoryUrl: Attribute.UID<'api::sub-category.sub-category', 'name'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
